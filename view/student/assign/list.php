...
foreach($submissions as $submission){
    ...
    echo html_writer::tag('td', html_writer::link(new moodle_url('/course/view.php', array('id' => $submission->course)), $submission->fullname));
    echo html_writer::tag('td', html_writer::link(new moodle_url('/blocks/mamiline/view/student/assign/assign.php', array('id' => $submission->id )), get_string('assign_viewassign','block_mamiline'), array('class' => 'btn btn-success')));
    echo html_writer::end_tag('tr');
}
